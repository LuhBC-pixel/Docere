...
const NavbarLinks = dynamic(() => import("./_subComponents/Navbar/NavbarLinks"))
const NavbarIcons = dynamic(() => import("./_subComponents/Navbar/NavbarIcons"))
const NavbarImage = dynamic(() => import("./_subComponents/Navbar/NavbarImage"))
