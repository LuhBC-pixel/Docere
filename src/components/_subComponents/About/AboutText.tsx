...
const AboutText = () => {
	return (
		<Box display="flex" flex="1" flexDirection="column" justifyContent="center" marginTop={{ base: "3", sm: "0" }}>
			<Heading marginTop="1">Uma maneira de espalhar a educação para todos!</Heading>
			<AboutComponentsText
				text={"É um aplicativo que além de capacitar os pais a ensinarem aos seus filhos, ensina para qualquer um!"}
			/>
			<AboutComponentsText
				text={
			...
			/>
			<AboutComponentsText text={"O usuário escolhe qual(is) matéria(s) ele deseja cursar."} />
			<AboutComponentsText
				text={
